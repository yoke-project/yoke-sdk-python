...
| **Planning item** | yoke-project/yoke-sdk-python#2 |

## yoke-sdk-python:continuous-integration.01 — every proposed change runs the verbs, and nothing else does work
...
## yoke-sdk-python:continuous-integration.02 — what a run needs is declared, not taken from the runner
