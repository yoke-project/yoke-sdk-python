...
# std: yoke-sdk-python:the-record-of-a-run.01
...
# std: yoke-sdk-python:the-record-of-a-run.02
check_the_record_is_assembled_from_them() {
  ...
  local tmp written
  tmp="$(mktemp -d)"
  record_fixture "$tmp" pass "yoke-sdk-python:verbs-and-licence.01"
...
if record["repository"] != "yoke-sdk-python":
...
# std: yoke-sdk-python:the-record-of-a-run.03
check_a_failing_run_is_recorded_as_one() {
  ...
  local tmp written
  tmp="$(mktemp -d)"
  record_fixture "$tmp" fail "yoke-sdk-python:verbs-and-licence.01"
...
# std: yoke-sdk-python:the-record-of-a-run.04
...
# std: yoke-sdk-python:the-record-of-a-run.05
