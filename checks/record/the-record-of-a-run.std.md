...
| **Planning item** | yoke-project/yoke-sdk-python#7 |

## yoke-sdk-python:the-record-of-a-run.01 — the verb undertakes to leave its results, whatever it decided
...
## yoke-sdk-python:the-record-of-a-run.02 — the record is assembled from them, and names what no runner knows
...
## yoke-sdk-python:the-record-of-a-run.03 — the record of a failing run says so, and blocks
...
## yoke-sdk-python:the-record-of-a-run.04 — the workflow hands the record over, and can fail nothing
...
## yoke-sdk-python:the-record-of-a-run.05 — nothing a run writes enters the tree
