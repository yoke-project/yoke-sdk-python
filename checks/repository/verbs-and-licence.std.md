...
| **Planning item** | yoke-project/yoke-sdk-python#1 |

## yoke-sdk-python:verbs-and-licence.01 — every verb is defined, and none is silent
...
## yoke-sdk-python:verbs-and-licence.02 — nothing resolves a path outside the repository
...
## yoke-sdk-python:verbs-and-licence.03 — the repository builds in the container it defines itself
...
## yoke-sdk-python:verbs-and-licence.04 — the licence is the one this repository's role assigns
...
## yoke-sdk-python:verbs-and-licence.05 — `develop` fails on a runner older than the floor
...
## yoke-sdk-python:verbs-and-licence.06 — `fmt` fails on an unformatted tree
...
| **Not applicable in** | — |
| **Label** | blocking |
| **Precondition** | a copy of the checkout with one Python file left unformatted |
