...
| **Planning item** | yoke-project/yoke-sdk-python#11 |

## yoke-sdk-python:the-check-runner.01 — a check whose name holds a digit is run
...
## yoke-sdk-python:the-check-runner.02 — a marker whose check cannot be found is reported as failing
